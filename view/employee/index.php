...
<ul>
    <?php foreach ($employees as $employee) { ?>
        <li>
            ...
            $employeeString = $employee['name'] . " is " . $employee['age'] . " jaar.";
            ?>
            <span><?= $employeeString ?></span>
            <a href="<?=URL?>employee/update/<?= $employee['id'] ?>">Wijzigen</a> <a href="<?=URL?>employee/delete/<?= $employee['id'] ?>">Verwijderen</a>
        </li>
    <?php } ?>
</ul>